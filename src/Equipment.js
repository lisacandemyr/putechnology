    ...
    <div className="Equipment hidden">
      <section className="equipment" id="equipment">
          <div className="row">
            ...
            <button className="col equipment-btn-2">RimStar Smart</button>
            <button className="col equipment-btn-3">Presses & Jig Handling Systems</button>
            <button className="col equipment-btn-4">Foam Dispensing Equipment</button>
            <button className="col equipment-btn-5">Discontinuous Press Injection Process</button>
          </div>
        ...
        <div className="equipment-2 hidden">
          <h4>RimStar Smart</h4>
         <div className="grid">
          <div className="grid-item-1">
          <p>
          ...
          <div className="grid-item-2">
          <img src="src/equipment-2-2.png" className="img-fluid" alt="" />
          <img src="src/equipment-2-3.png" className="img-fluid" alt="" />
          <img src="src/equipment-2-4.png" className="img-fluid" alt="" />
          <img src="src/equipment-2-1.jpg" className="img-fluid" alt="" />
          </div>
         </div>
        </div>
        <div className="equipment-3 hidden">
        ...
        <div className="equipment-4 hidden">
        ...
        <div className="equipment-5 hidden">
